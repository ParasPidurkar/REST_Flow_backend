...
var username ="seller2";
var soldier_asset = "soldier#200#60#soldier.jpg#action#tony_doe.john_snow#5"
var wildlife_asset = "wildlife#200#60#wildlife.jpg#action#sarutobi.uzumaki_naruto#5"
																		...
																		function (error, stdout, stderr) {		
																			...
																			if(error){
																				console.log('Issue in adding balance in new user Account : ' + error);
																					...
																					var wildlife_assetCmd = wildlife_asset.split(1,-1)
																					var soldier_assetCmd = soldier_asset.split(1,-1)
                                                                                                ...
                                                                                                console.log('Issue in getting the marketplace data for the user : ' + error);
                                                                                                    ...
                                                                                                    if(error){
                                                                                                        console.log('Issue in getting the marketplace data for the user : ' + error);
																											...
																											let add_rewardCmd=`flow transactions send ./transactions/rewards/admin/create_reward.cdc --arg String:${wildlife_assetCmd}} --arg UInt32:250`
																											child = exec(add_rewardCmd,
																											function (error, stdout, stderr) {		
																											retStdOut = stdout;		
																											if(error){
																														...
																														console.log('Issue in getting the marketplace data for the user : ' + error);
																															...
																															if(error){
																																console.log('Issue in getting the marketplace data for the user : ' + error);
																																	...
																																	let add_rewardCmd=`flow transactions send ./transactions/rewards/admin/create_reward.cdc --arg String:${soldier_assetCmd}} --arg UInt32:250`
																																	child = exec(add_rewardCmd,
																																	function (error, stdout, stderr) {		
																																	retStdOut = stdout;		
																																	if(error){
